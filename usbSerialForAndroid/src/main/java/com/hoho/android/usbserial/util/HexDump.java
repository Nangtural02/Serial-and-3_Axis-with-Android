...
public class HexDump {
    ...
    public static String getLineString(byte[] array) {
        return getLineString(array, 0, array.length);
    }

    public static String getLineString(byte[] array, int offset, int length) {
        StringBuilder result = new StringBuilder();
